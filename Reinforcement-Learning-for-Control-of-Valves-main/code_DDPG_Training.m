...
actInfo = rlNumericSpec([1 1],'LowerLimit', 0.01, 'UpperLimit', 0.15);
actInfo.Name = 'flow';
...
% Default: 0.45, 1e-5
DDPG_Variance = 1.5;
DDPG_VarianceDecayRate = 1e-5; % Half-life oriance;f 1,000 episodes
% agentOpts.NoiseOptions.Variance = DDPG_Va
...
function in = localResetFcn(in, RL_System)
    ...
    Reference_Signal = 15+randi(6) + rand;
